...
from src.visualization.utils import generate_heatmap_pytorch, get_fool_sample, preprocess_sample, visualize_heatmap
...
class LightningBagNet(LightningModule):
    def __init__(self, num_classes=1000, num_channels=3, lr=0.001):
        ...
        self.model = get_bagnet(bagnet_layers=9, num_classes=num_classes, num_channels=num_channels)
